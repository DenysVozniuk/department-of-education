    ...
    let cardList = [
        ...
        },
        {
            ...
            collapsibleContent: {
                ...
                collapsibleText: 'У книзі а основі Святого Письма автор дає характеристику дарів і плодів Святого Духа, показує різницю між ними, визнаючи домінуючий вплив плодів Духа. Для всіх, хто цікавиться Святим Духом та духовними дарами.'
            }
            //audioPrice: 300,
        },
        {
        ...
        },
        {
            ...
            collapsibleContent: {
                ...
                collapsibleInfoText2: 'У наявності укр. мовою',
                collapsibleText: 'У книзі детально викладені доктрини про Бога, Писання, Христа, людину, гріх, демонологія, вічний стан тощо. Порушені також питання про людську і божественну природу Христа, призначення і передбачення людини.'
            }
        },
        {
            image: bookPhoto7,
            ...
            collapsibleContent: {
                ...
                collapsibleInfoText2: 'У наявності укр. мовою',
                collapsibleText: 'Книга, що точно допоможе вам зробити правильні кроки на шляху до створення  сім’ї та допоможе вам зрозуміти Божий задум про сім’ю.'
            }
        },
        {
            image: bookPhoto15,
            ...
            collapsibleContent: {
                ...
                collapsibleInfoText2: 'У наявності укр. мовою',
                collapsibleText: 'Створюючи книгу на сімейну тематику, Департамент освіти прагне допомогти сімейним парам зробити правильні кроки у процесі побудови і розвитку сім’ї.'
            }
        },
        {
            image: bookPhoto9,
        ...
        },
        {
            ...
            collapsibleContent: {
                ...
                collapsibleInfoText2: 'У наявності укр. мовою',
                collapsibleText: 'Ця збірка є результатом літературного конкурсу ім. Джона Буньяна у 2017-ому році. Історії, що торкаються серця.'
            }
        },
        {
            image: bookPhoto11,
        ...
        },
        {
            ...
            collapsibleContent: {
                ...
                collapsibleInfoText2: 'У наявності укр. мовою',
                collapsibleText: 'Ця збірка є результатом літературного конкурсу ім. Джона Буньяна у 2018-ому році. Правдиві та вигадані оповідання, які розчулюють.'
            }
        },
        {
            image: bookPhoto8,
            ...
            collapsibleContent: {
                collapsibleInfoText1: 'Друкована версія, 72 сторінки',
                collapsibleInfoText2: 'У наявності рос. мовою',
                collapsibleText: 'У книзі пастор описує власну історію перемоги над відчаєм і душевними тривогами та дає практичні поради про те, як боротися з депресією, мінімізувати можливість її виникнення та яка роль християнської віри в цьому всьому.'
            }
        },
        {
            image: bookPhoto13,
